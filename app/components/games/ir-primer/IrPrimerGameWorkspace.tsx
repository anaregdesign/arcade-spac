...
import { useIrPrimerWorkspace } from "../../../lib/client/usecase/game-workspace/ir-primer/use-ir-primer-workspace";
...
import styles from "./IrPrimerGameWorkspace.module.css";

export function IrPrimerGameWorkspace({ instructions, workspace }: GameWorkspaceComponentProps) {
  const { locale } = useAppLocale();
  const screen = useIrPrimerWorkspace(workspace, locale);
