...
export const supportedGames = [
  ...
  },
  {
    ...
    rulesSummary: "Read the IR study pages, answer the full quiz, and finish before the timer expires. Wrong answers count as mistakes but do not stop the run.",
    shortDescription: "A study-first quiz on full-text search foundations based on Stanford's Introduction to Information Retrieval.",
    storedKey: "IR_PRIMER",
    successfulResultLabel: "clear",
    supportMetric: {
      kind: "count",
