...
const copyByLocale: Record<SupportedArcadeLocale, McpPrimerUiCopy> = {
  ...
  ja: {
    ...
    lessonPreviewFooter: "topic ごとの section を読み、そのたびに短いクイズで確認しながら進みます。",
    ...
    quizDetail: "直前に確認した section の学習内容をもとに現在の問題へ答えてください。",
  ...
  zh: {
    ...
    quizDetail: "根据刚刚阅读的当前 section 学习内容回答这道题。",
