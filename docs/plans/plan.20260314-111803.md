...
- [x] Restore the repository Azure extension skill from the canonical source.
...
- Rebound the vendored skill metadata and local relative links so the supported skill set resolves correctly from `.github/skills/`.
