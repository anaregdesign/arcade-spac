...
- [x] Create or update `.github/copilot-instructions.md` with the requested skill roles and invocation order.

## Section 3 - Verify And Close Out
- [x] Verify the installed skill files under `.github/skills/`.
- [x] Archive the completed execution plan.