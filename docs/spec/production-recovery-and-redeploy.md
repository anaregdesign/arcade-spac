...
- 当時の recovery scope では Azure SQL private networking への全面移行は follow-up とし、その後続対応は [azure-private-sql-and-entra-hardening.md](./azure-private-sql-and-entra-hardening.md) で扱う
